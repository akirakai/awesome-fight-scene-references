# Film / TV Action References

## Atomic Blonde — Stairwell Sequence
- Source: https://www.wired.com/video/watch/atomic-blonde-stairway-fight
- Study: continuous action, fatigue, environmental interaction, hidden edits.
- Camera: close tracking through stairs and rooms; transitions disguised by pans and foreground crossings.
- AI-video takeaway: useful template for a readable 10–15 second continuous close-quarters action sequence.
- Tags: one-take, stairwell, tracking, environmental-action

## Marvel's Daredevil — Hallway / Stairwell Sequences
- Source: https://www.marvel.com/articles/tv-shows/marvel-daredevil-best-fight-scenes
- Study: multi-performer staging in narrow spaces, clear geography, wave-based escalation.
- Camera: long lateral/depth tracking with natural foreground crossings.
- AI-video takeaway: useful for corridor action with one clear axis and staggered entrances.
- Tags: hallway, long-take, multi-performer, tracking

## Marvel Studios' Echo — Maya x Daredevil
- Source: https://www.marvel.com/watch/trailers-and-extras/marvel-studios-echo-maya-x-daredevil-fight-scene-disney-hulu
- Study: two-character choreography plus stunt-team breakdown.
- Camera: close enough for impact while preserving readable full-body movement.
- AI-video takeaway: define distinct movement styles and explicit action-response beats.
- Tags: duel, choreography, stunt-design, readable-action

## Hero (2002) — Calligraphy and Swordplay
- Source: https://www.calligraphy-museum.com/cn/about/films/zhang-yi-mou-dao-yan-ying-xiong-dian-ying-pian-duan
- Study: wuxia movement, visual motifs, sword trajectories, environment and composition.
